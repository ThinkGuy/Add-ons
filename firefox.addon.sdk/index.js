...
function useXUL() {
  ...
  console.log("99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999");
  console.log(Cu);
  ...
  var windowListener = {
      ...
      unloadFromWindow: function (aDOMWindow, aXULWindow) {
          ...
          if (splitter) {
              var sidebar = aDOMWindow.document.querySelector('#CiteXploresidebar');
